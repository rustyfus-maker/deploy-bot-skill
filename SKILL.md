---
name: deploy-bot
description: Use this skill whenever a user wants to deploy an app, asks how to host code on AWS, Azure, GCP, or multiple clouds, needs infrastructure-as-code, wants a deployment diagram, or is unsure which cloud services match their codebase. This skill inspects the project, interviews the user briefly, recommends a cloud architecture, and produces a deployment package with diagrams, service tables, and implementation steps.
---

# Deploy-Bot

Deploy-Bot turns an unknown codebase into a practical cloud deployment plan. It is for users who say things like “I have this app and no idea how to deploy it,” “put this on AWS/Azure/GCP,” “make a deployment package,” or “what cloud services do I need?”
...
3. **Provider decision** — AWS, Azure, GCP, or multi-cloud/hybrid, with rationale.
...
- Runtime files: `Dockerfile`, `docker-compose.yml`, `Procfile`, `serverless.yml`, `kubernetes/`, `helm/`, `terraform/`, `infra/`.
...
1. Which target do you prefer: AWS, Azure, GCP, cheapest viable, easiest managed path, or multi-cloud?
...
7. Preferred deployment style: serverless, containers, Kubernetes, VM, or “choose for me”?
8. Should the package include Terraform, provider-native IaC, GitHub Actions, Docker, or all of these?
...
- Static frontend: CDN + object/static hosting.
- SSR or full-stack JavaScript: managed app hosting, container runtime, or serverless container.
- API/backend: managed container or serverless function depending on runtime shape.
...
- CI/CD: GitHub Actions with environment protection and least-privilege cloud credentials.
- Observability: provider-native logs/metrics/alerts first.
